...
[@orangecheck/design](../README) / OcAccountMenuItem

# Interface: OcAccountMenuItem

Defined in: [chrome/account-menu.tsx:51](https://github.com/orangecheck/oc-packages/blob/main/design/src/chrome/account-menu.tsx#L51)
...
| ------ | ------ | ------ | ------ |
| &lt;a id="property-external">&lt;/a> `external?` | `boolean` | When `true`, opens in a new tab and renders a ↗ glyph after the label. Use for cross-domain links (e.g. `https://ochk.io/dashboard`). | [chrome/account-menu.tsx:60](https://github.com/orangecheck/oc-packages/blob/main/design/src/chrome/account-menu.tsx#L60) |
| &lt;a id="property-href">&lt;/a> `href` | `string` | Same-origin path or absolute URL. | [chrome/account-menu.tsx:53](https://github.com/orangecheck/oc-packages/blob/main/design/src/chrome/account-menu.tsx#L53) |
| &lt;a id="property-label">&lt;/a> `label` | `string` | Visible label. | [chrome/account-menu.tsx:55](https://github.com/orangecheck/oc-packages/blob/main/design/src/chrome/account-menu.tsx#L55) |
