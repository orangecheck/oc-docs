export const metadata = {
    ...
    description:
        '@orangecheck/me-client v0.4.0 SDK reference. useOcSession, oc.session, oc.payment, oc.config, oc.webhook, oc.delegation, plus every type the SDK exports.',
};

# `@orangecheck/me-client` · SDK reference

**v0.4.0 · MIT · 11 KB ESM · 7 KB DTS.**
