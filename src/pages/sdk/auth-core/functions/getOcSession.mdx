...
[@orangecheck/auth-core](../README) / getOcSession
...
Defined in: [index.ts:775](https://github.com/orangecheck/oc-packages/blob/main/auth-core/src/index.ts#L775)
...
| Parameter | Type |
| ------ | ------ |
| `headers` | \| `Headers` \| [`SessionRequestHeaders`](../interfaces/SessionRequestHeaders) |
| `options` | [`VerifyOcOptions`](../interfaces/VerifyOcOptions) |

## Returns

`Promise`\&lt;[`SessionPayload`](../interfaces/SessionPayload) \| `null`\>
