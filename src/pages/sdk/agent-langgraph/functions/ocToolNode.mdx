...
[@orangecheck/agent-langgraph](../README) / ocToolNode
...
| Parameter | Type |
| ------ | ------ |
| `input` | [`OcToolNodeInput`](../interfaces/OcToolNodeInput)\&lt;`TArgs`, `TResult`\> |

## Returns

[`OcToolNodeWrapped`](../interfaces/OcToolNodeWrapped)\&lt;`TArgs`, `TResult`\>
