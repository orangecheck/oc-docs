...
[@orangecheck/auth-client](../README) / useOcAddressSuggestion
...
Defined in: [components.tsx:538](https://github.com/orangecheck/oc-packages/blob/main/auth-client/src/components.tsx#L538)
...
| Parameter | Type |
| ------ | ------ |
| `options` | [`UseOcAddressSuggestionOptions`](../interfaces/UseOcAddressSuggestionOptions) |
