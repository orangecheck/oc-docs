import { FamilyGrid } from '@/components/docs/FamilyGrid';
...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| **[OC Me](/me)** | Consumer-side Bitcoin-backed identity. Sign in with your address; integrators pay you sats per billable event. OrangeCheck holds the balance during bring-up; federation custody and self-custody graduation are the destination. | end users + sites that want sat-paying user auth |
