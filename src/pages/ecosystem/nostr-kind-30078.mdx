...
- [Canonical message](/ecosystem/canonical-message) — what goes inside each event's `content` field
- [BIP-322 signing](/ecosystem/bip322) — what ties the Nostr event to the Bitcoin address
- [Security model](/ecosystem/security) — relay assumptions and partition mitigation
