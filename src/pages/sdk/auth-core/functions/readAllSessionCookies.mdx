...
[@orangecheck/auth-core](../README) / readAllSessionCookies
...
Defined in: [index.ts:487](https://github.com/orangecheck/oc-packages/blob/main/auth-core/src/index.ts#L487)
