export const metadata = {
    ...
    description: 'Normative specification. Delegation, agent-action, revocation envelopes. Scope grammar. Verification algorithm. Error codes.',
};

# Specification

The normative v1 specification lives in the [`oc-agent-protocol`](https://github.com/orangecheck/oc-agent-protocol/blob/main/SPEC.md) repository. This page is a shortened reference for implementers who already understand the protocol. Consult the upstream SPEC.md for the complete text, notation, test vectors, and compliance checklist.
...
- [Scope grammar](/agent/scopes) for the full BNF and the sub-scope decision procedure.
- [Test vectors](https://github.com/orangecheck/oc-agent-protocol/tree/main/test-vectors) for cross-implementation conformance.
- [`@orangecheck/agent-core`](https://github.com/orangecheck/oc-packages/tree/main/agent-core) for the reference TypeScript implementation.
