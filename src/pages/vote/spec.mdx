export const metadata = {
    title: 'specification',
    description: 'This page is the human-readable mirror of oc-vote-protocol/SPEC.md v0. The GitHub version is the normative one — if this page ever drifts, the repo wins.',
};
