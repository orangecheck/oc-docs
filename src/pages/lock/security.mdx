...
If you are an implementer or researcher, you probably want the protocol's [`SECURITY.md`](https://github.com/orangecheck/oc-lock-protocol/blob/main/SECURITY.md) instead — it covers normative compliance, dependency posture, and reporting process.
...
- Consider self-hosting from the [`oc-lock-web`](https://github.com/orangecheck/oc-lock-web) source for high-value scenarios.
...
Email `security@ochk.io`. See the [protocol repo's `SECURITY.md`](https://github.com/orangecheck/oc-lock-protocol/blob/main/SECURITY.md) for the full process: response time targets, scope, normative compliance requirements, and dependency posture.
