 ...
 * just outside-click + Escape + Tab handling so it works identically in
 * every site without forcing a peer-dep upgrade. Every link stays
 * in-tab — the family is one app from the user's POV.
 */
