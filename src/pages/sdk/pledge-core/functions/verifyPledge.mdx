...
[@orangecheck/pledge-core](../README) / verifyPledge
...
| Parameter | Type |
| ------ | ------ |
| `input` | [`VerifyPledgeInput`](../interfaces/VerifyPledgeInput) |

## Returns

`Promise`\&lt;[`VerifyPledgeResult`](../type-aliases/VerifyPledgeResult)\>
