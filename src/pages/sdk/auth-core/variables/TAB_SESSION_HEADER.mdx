...
[@orangecheck/auth-core](../README) / TAB\_SESSION\_HEADER
...
Defined in: [index.ts:515](https://github.com/orangecheck/oc-packages/blob/main/auth-core/src/index.ts#L515)
