...
| --------------------------- | --------------------- | ------------------------------------------------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------- |
| **Delegation**              | `agent-delegation`    | 30083 _(co-claimed with OC Stamp; disjoint `d`-tag prefixes)_ | `oc-agent-del:` | Principal grants the agent scoped authority.                                                                           |
| **Agent-action**            | `agent-action`        | 30084 _(claimed exclusively; reuses OC Stamp envelope shape)_ | `oc-agent-act:` | Agent exercises the delegation.                                                                                        |
| **Revocation**              | `agent-revocation`    | 30085 _(claimed exclusively)_                                 | `oc-agent-rev:` | Principal (or agent) burns the delegation.                                                                             |
| **Sub-delegation** _(v1.1)_ | `agent-subdelegation` | 30086 _(claimed exclusively)_                                 | `oc-agent-sub:` | Agent grants a _narrower_ slice of its delegated rights to another agent. See [sub-delegation](/agent/sub-delegation). |
