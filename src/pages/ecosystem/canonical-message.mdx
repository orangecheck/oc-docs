...
is reused across Attest, Lock, Stamp, and Vote (Agent will follow). By
specifying the bytes exactly, two independent implementations produce
byte-identical messages and therefore byte-identical attestation IDs.
