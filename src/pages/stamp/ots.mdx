export const metadata = {
    ...
    description: 'OC Stamp uses OpenTimestamps for block-anchored priority. We do not reimplement OTS. We compose with it.',
};

export const meta = {
    title: 'OpenTimestamps integration — OC Stamp docs',
    description: 'How OC Stamp anchors envelope ids to a Bitcoin block via OpenTimestamps.',
};

# OpenTimestamps integration

OC Stamp uses [OpenTimestamps](https://opentimestamps.org) for block-anchored priority. We do not reimplement OTS. We compose with it.
...
import { makeAnchorVerifier, adaptAnchorVerifier, hexDecode } from '@orangecheck/stamp-ots';
...
- [`javascript-opentimestamps`](https://github.com/opentimestamps/javascript-opentimestamps) — the reference parser to plug in.
- [SPEC §6](https://github.com/orangecheck/oc-stamp-protocol/blob/main/SPEC.md#6-opentimestamps-integration) — normative rules.
