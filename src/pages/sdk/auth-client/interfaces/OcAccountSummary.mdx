...
[@orangecheck/auth-client](../README) / OcAccountSummary
...
| &lt;a id="property-displayidentity">&lt;/a> `displayIdentity` | [`DisplayIdentity`](DisplayIdentity) | - | [types.ts:119](https://github.com/orangecheck/oc-packages/blob/main/auth-client/src/types.ts#L119) |
