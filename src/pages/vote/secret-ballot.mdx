export const metadata = {
    title: 'secret ballot',
    description: 'In secret mode, each ballot is an OC Lock envelope addressed to a poll-specific X25519 reveal keypair. At deadline the creator publishes reveal_sk.',
};
