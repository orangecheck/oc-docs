...
Defined in: [me-client/src/event.ts:198](https://github.com/orangecheck/oc-packages/blob/main/me-client/src/event.ts#L198)
...
| &lt;a id="property-ok">&lt;/a> `ok` | `boolean` | True iff every expected fee equals the recorded fee. | [me-client/src/event.ts:200](https://github.com/orangecheck/oc-packages/blob/main/me-client/src/event.ts#L200) |
