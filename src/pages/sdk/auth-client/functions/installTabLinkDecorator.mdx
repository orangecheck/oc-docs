...
[@orangecheck/auth-client](../README) / installTabLinkDecorator
...
Returns an uninstaller. Mirrors [installTabFetchInterceptor](installTabFetchInterceptor)'s
conservatism:
...
[consumeTabAccountHint](consumeTabAccountHint).
