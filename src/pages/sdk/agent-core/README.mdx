...
- [ScopeNotGrantedError](classes/ScopeNotGrantedError.mdx)
...
- [ScopeBearingDelegation](interfaces/ScopeBearingDelegation.mdx)
...
- [assertScopeGranted](functions/assertScopeGranted.mdx)
