export const metadata = {
    title: 'security',
    description: 'Short form. The normative threat model lives in oc-vote-protocol/SECURITY.md — 14 numbered attack scenarios with status.',
};

# security

Short form. The normative threat model lives in [`oc-vote-protocol/SECURITY.md`](https://github.com/orangecheck/oc-vote-protocol/blob/main/SECURITY.md) — 14 numbered attack scenarios with status.
