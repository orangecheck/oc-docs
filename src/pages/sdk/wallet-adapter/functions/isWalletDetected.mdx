...
[@orangecheck/wallet-adapter](../README) / isWalletDetected
...
Defined in: [wallet-adapter/src/detect.ts:135](https://github.com/orangecheck/oc-packages/blob/main/wallet-adapter/src/detect.ts#L135)
...
| Parameter | Type |
| ------ | ------ |
| `id` | [`WalletId`](../type-aliases/WalletId) |
