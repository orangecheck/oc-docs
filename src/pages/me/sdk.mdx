export const metadata = {
    ...
    description:
        '@orangecheck/me-client v0.6.0 SDK reference. Three entry points: main (React surface), /server (framework adapters — Next.js, Express, Hono), /popup (browser-only signin orchestrator). useOcSession, oc.session, oc.payment, oc.event, plus every type the SDK exports.',
};
