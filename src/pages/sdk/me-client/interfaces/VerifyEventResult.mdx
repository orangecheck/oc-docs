...
[@orangecheck/me-client](../README) / VerifyEventResult

# Interface: VerifyEventResult

Defined in: [me-client/src/event.ts:313](https://github.com/orangecheck/oc-packages/blob/main/me-client/src/event.ts#L313)
