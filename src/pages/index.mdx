export const metadata = {
    ...
    description:
        'Unified docs for the OrangeCheck ecosystem — six open protocols (Attest, Lock, Stamp, Vote, Agent, Pledge), two commercial products (Me, Fleet), and the company-wide charter. Shared concepts up top, protocol and product sections below.',
};
...
| **[OC Fleet](/fleet)** | Managed enterprise tier for OC Agent and OC Pledge. Integration adapters, webhook signing service, audit-bundle generation, compliance review. Same envelopes as the open protocol path. | enterprises running AI agents under bounded authority |
...
- **[OC Me](/me) · [OC Fleet](/fleet)** — the two commercial products. Each
...
- [**OC Fleet overview**](/fleet) — managed Agent + Pledge for enterprises
