...
| **[OC Agent](/agent)**   | Agent-authorization records bound to a signer's Bitcoin address.                                                                  | design  |
...
|                           | Repo                                                                                                         |
| ------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Canonical protocol spec   | [`oc-protocol`](https://github.com/orangecheck/oc-protocol) (CC-BY-4.0)                                      |
