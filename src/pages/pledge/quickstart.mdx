...
reference reputation function — by design. Platforms compute derived
policies from raw queries; that's the
[composition surface](/pledge/composition).

## What's next

- [How it works](/pledge/how-it-works) — the canonical message, the seven
  resolution mechanisms, the outcome envelope shape
- [Resolution grammar](/pledge/resolution-grammar) — every mechanism in
  detail
