...
[@orangecheck/pledge-core](../README) / AttestationLookup
...
Defined in: [pledge-core/src/types.ts:520](https://github.com/orangecheck/oc-packages/blob/main/pledge-core/src/types.ts#L520)
