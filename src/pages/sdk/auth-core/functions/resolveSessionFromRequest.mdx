...
[@orangecheck/auth-core](../README) / resolveSessionFromRequest
...
Defined in: [index.ts:552](https://github.com/orangecheck/oc-packages/blob/main/auth-core/src/index.ts#L552)
...
Crypto-only (signature + exp + iss via [verifySessionToken](verifySessionToken));
...
| Parameter | Type |
| ------ | ------ |
| `headers` | [`IncomingRequestHeaders`](../type-aliases/IncomingRequestHeaders) |
| `cfg` | [`VerifyConfig`](../interfaces/VerifyConfig) |

## Returns

`Promise`\&lt;[`ResolveSessionResult`](../type-aliases/ResolveSessionResult)\>
