...
[@orangecheck/pledge-core](../README) / createAbandonment
...
| Parameter | Type |
| ------ | ------ |
| `input` | [`CreateAbandonmentInput`](../interfaces/CreateAbandonmentInput) |

## Returns

`Promise`\&lt;[`AbandonmentEnvelope`](../interfaces/AbandonmentEnvelope)\>
