...
[@orangecheck/me-client](../README) / SigningMethod
...
Defined in: [me-client/src/types.ts:562](https://github.com/orangecheck/oc-packages/blob/main/me-client/src/types.ts#L562)
