...
[@orangecheck/auth-client](../README) / fetchOcLinkedIdentities
...
Defined in: [linked-identities.tsx:77](https://github.com/orangecheck/oc-packages/blob/main/auth-client/src/linked-identities.tsx#L77)
...
`Promise`\&lt;[`OcLinkedIdentity`](../interfaces/OcLinkedIdentity)[]\>
