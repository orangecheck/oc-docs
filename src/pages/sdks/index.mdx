...
| `@orangecheck/agent-cli`  | Shell interface to issue / revoke / inspect delegations.                                     |
...
| `@orangecheck/pledge-cli`  | Shell interface to make / attest / dispute / resolve pledges.                                                                    |
