...
When a pledge's outcome is contested (e.g. "did the deliverable ship on time and
to spec?"), the dispute mechanism can be a stake-weighted OC Vote poll with the
pledger and counterparty bonded. The tally settles the pledge.
