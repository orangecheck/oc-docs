...
[@orangecheck/me-client](../README) / computeFees
...
Defined in: [me-client/src/types.ts:183](https://github.com/orangecheck/oc-packages/blob/main/me-client/src/types.ts#L183)
...
| Parameter | Type |
| ------ | ------ |
| `cfg` | [`IntegratorEventConfig`](../interfaces/IntegratorEventConfig) |
| `payment_amount_sats?` | `number` |
