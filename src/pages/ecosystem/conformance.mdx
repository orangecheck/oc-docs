...
| --------- | ---------------------------------------------------------------------------------------------------------- | ------------------ | ----------------------------------------------------- |
| OC Attest | [`oc-protocol/conformance/vectors/`](https://github.com/orangecheck/oc-protocol/tree/main/conformance)     | 23 (`tv01`–`tv23`) | `sdk/src/__tests__/vectors/`, `sdk-py/tests/vectors/` |
