...
[@orangecheck/auth-core](../README) / ResolveSessionResult
...
Defined in: [index.ts:517](https://github.com/orangecheck/oc-packages/blob/main/auth-core/src/index.ts#L517)
